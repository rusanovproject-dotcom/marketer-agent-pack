...
trigger_keywords: [маркетинг, маркетолог, ЦА, целевая аудитория, сегмент, сегменты, оффер, позиционирование, воронка, лид-магнит, трипваер, лестница, продуктовая линейка, Hormozi, , распакуй ЦА, ревизия, где деньги, avatar, ICP, провёл диагностику, был созвон, клиент оплатил, клиент отказался]
version: 1.0.0
requires: []
```
